		...
		<div>
			...
			<div className="flex flex-row justify-center">
				<div
					...
					style={{ width: "500px" }}>
					<img
						src={`${import.meta.env.PUBLIC_URL}/yoga.png`}
						alt="Example Image"
						width="500"
						height="400"
					/>
					<Card width="100%">
						We focus on propagating hathayoga in its original form
						with proper breath focus & vinyasa processes. With our
						affiliation to VYASA and through our Quality Council of
						India (QCI) certified teachers, our excellence is
						unmatched! Take our trial class and you will surely join
