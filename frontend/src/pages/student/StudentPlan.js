    ...
    <StudentPageWrapper heading="Plans">
              ...
              myPlans.map((x) => (
                ...
                >
                  <div className="grid grid-cols-3">
                    ...
                    <span>
                      VALID FROM : {new Date(x.validity_from).toDateString()}
                    </span>
                    <span>
                      VALID TO : {new Date(x.validity_to).toDateString()}
                    </span>
                  </div>
                </Note>
              ))}
      ...
      <div className="mx-auto mt-10 flex w-full max-w-7xl justify-end">
        <div>
          <p className="text-right">
            Select A Currency |{" "}
            {currencies.length > 0 ? currencies[0].short_tag : "???"} | Selected
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-center pt-10">
        ...
        <Modal visible={showCard} onClose={() => setShowCard(false)}>
                  ...
                  <h6>
                    ...
                    cardData.playlist_creation_limit ? (
                      cardData.playlist_creation_limit === 1000000 ? (
                        <FeatureTag>
                          Create UNLIMITED yoga playlists of your own, using our
                          asana videos
                        </FeatureTag>
                      ) : (
                        <FeatureTag>
          ...
          <Modal.Action onClick={() => setShowCard(false)}>Close</Modal.Action>
        </Modal>
      </div>
