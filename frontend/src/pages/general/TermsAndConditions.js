  ...
  return (
    <PageWrapper>
      <Card width="100%" type="dark">
        ...
        <Text>
          Acceptance of Terms : By accessing the website, you agree to be bound
          by these Terms and Conditions, all applicable laws and regulations,
        ...
        <Text>
          ...
          content by 6AM Yoga facilitated by your chosen teacher or institution
          ("Teacher"). You must comply with all rules and guidelines set by the
          Teacher and our website.
        </Text>
        <Text>
          ...
          videos. You must adhere to all guidelines and codes of conduct set by
          your Teacher.
        </Text>
        <Text>
          Payments : If applicable, payments for the services must be made
          through the platform or as directed by your Teacher. All payments are
          subject to the terms and conditions set by the Teacher and the
          platform.
        </Text>
        <Text>
          Privacy : Your privacy is important to us. Please review our Privacy
          Policy for information on how your personal information is collected,
          used, and shared.
        </Text>
        <Text>
          Intellectual Property : All content, including but not limited to
          class materials, videos, and documents provided by the Teacher, is the
          intellectual property of the Teacher or other rightful owners. You may
          not distribute, reproduce, or use this content in any way without
          express permission.
        </Text>
        <Text>
          Disclaimers and Limitations of Liability : 6AM Yoga and the Teacher
          make no warranties, expressed or implied, and hereby disclaim and
          negate all other warranties. Neither 6AM Yoga nor the Teacher shall be
        ...
        <Text>
          ...
          the jurisdiction in which your Teacher operates, and any disputes will
