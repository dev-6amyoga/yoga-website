				...
				<Modal
					...
					<Modal.Content>
						<form>
							...
							<Select
								placeholder={
									modalData.has_basic_playlist ? "Yes" : "No"
								}
								onChange={(value) =>
									handleInputChange(
										value,
							...
							<Select
								placeholder={
									modalData.has_playlist_creation
										? "Yes"
										: "No"
								}
								onChange={(value) =>
							...
							<Select
								placeholder={
									modalData.has_self_audio_upload
										? "Yes"
										: "No"
								}
								onChange={(value) =>
							...
							<Select
								placeholder={
									modalData.plan_user_type
										? "Institute"
										: "Student"
								}
								onChange={(value) =>
									handleInputChange(value, "plan_user_type")
								}
								id="plan_user_type">
