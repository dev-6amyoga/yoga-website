...
export default function AttendanceByUser() {
                ...
                <Grid container spacing={isMobile ? 1.5 : 2}>
                  <Grid item xs={12} sm={4}>
                    <Autocomplete
                      ...
                      value={
                        users.find((u) => u.user_id === entry.user_id) || null
                      }
                      onChange={(e, newValue) =>
                        handleUserSelect(idx, newValue)
                      }
                      renderInput={(params) => (
                        <TextField
                          {...params}
                      ...
                      >
                        {loadingClasses ? (
                          ...
                          getFilteredClasses(entry.plan_id).map((cls) => (
                            ...
                            >
                              {cls.zoom_class_name} - {cls.recurring_start_time}{" "}
                              to {cls.recurring_end_time}
                            </MenuItem>
                          ))
                        ) : (
