        ...
        >
          <CardContent>
            ...
            <div className="text-2xl text-center">
              <DisplayWatchTime
                endTs={new Date(classInfo?.onetime_class_start_time)}
              />
            </div>
          </CardContent>
        </Card>
        ...
        >
          <CardContent>
            ...
            <div className="text-2xl">
              <DisplayWatchTime
                endTs={new Date(classInfo?.onetime_class_end_time)}
              />
            </div>
          </CardContent>
        </Card>
            ...
            <div className="class-info-student-info flex flex-col gap-8 text-sm text-white">
              <div className="flex flex-row gap-8">
                ...
                <div>
                  ...
                  <p>
                    {classInfo?.end_time && classInfo?.onetime_class_start_time
                      ? (new Date(classInfo.onetime_class_end_time) -
                          new Date(classInfo.onetime_class_start_time)) /
                        1000 /
                        60
                      : 0}
                    minutes
