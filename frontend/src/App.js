    ...
    <PageWrapper>
      <div className="relative w-full h-screen">
        <Container className="flex flex-col items-center pt-14 sm:pt-20 pb-8 sm:pb-12">
          <Stack spacing={2} className="w-full sm:w-7/12 pt-16">
            <Typography
              variant="h4"
              className="text-center text-2xl sm:text-3xl md:text-4xl flex flex-col md:flex-row px-8 font-normal" // Removed bold by adding font-normal
            >
              My Yoga&nbsp;
              <Typography
                component="span"
                variant="h4"
                className="text-primary font-normal" // Removed bold from the span as well
              >
                Teacher
              </Typography>
            </Typography>
            ...
            <Typography
              textAlign="center"
              color="text.secondary"
              className="w-full sm:w-full md:w-8/12 mx-auto"
            >
              My Yoga Teacher is a comprehensive subscription-based online
              platform that empowers users to learn and practice yoga at their
              own pace, enabling a self-guided DIY approach.
