				...
				<Container className="flex flex-col items-center pt-14 sm:pt-20 pb-8 sm:pb-12">
					<div className="flex flex-col gap-2 text-center items-center mt-10">
						...
						<p className="max-w-xl mx-auto">
							My Yoga Teacher is a comprehensive
							subscription-based online platform that empowers
							users to learn and practice yoga at their own pace,
							enabling a self-guided DIY approach.
						</p>
					</div>
