...
//         const textStream =
//           // eslint-disable-next-line no-await-in-loop
//           await this.createExternalTextStream_(
//             manifest,
//             text.uri,
//             text.language,
//             text.kind,
...
//     const buffer = await this.getTextData_(
//       uri,
//       this.networkingEngine_,
...
//         shaka.util.MimeUtils.getFullType(segmentMimeType || "", ""),
//       ]),
...
//    * @private
//    */
//   async createExternalTextStream_(
//     manifest,
//     uri,
//     language,
//     kind,
...
// export default shaka.offline.Storage;
