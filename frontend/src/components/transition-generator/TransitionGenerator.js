            ...
            if (endVideo.nobreak_asana === true) {
                if (endVideo.person_starting_position === 'Front') {
                    const matchingTransition1 = transitions.find(
                        (transition) => {
                            return (
                                transition.asana_category_start ===
                                    'Standing' &&
                ...
                if (endVideo.person_starting_position === 'Left') {
                    ...
                    const matchingTransition2 = transitions.find(
                        (transition) => {
                            return (
                                transition.asana_category_start ===
                                    'Standing' &&
        ...
        if (
            ...
            if (
                ...
                if (
                    ...
                    const matchingTransition3 = transitions.find(
                        (transition) => {
                            return (
                                transition.asana_category_start ===
                                    'Standing' &&
            ...
            if (
                ...
                if (
                    ...
                    const matchingTransition4 = transitions.find(
                        (transition) => {
                            return (
                                transition.asana_category_start ===
                                    'Standing' &&
            ...
            if (
                ...
                if (
                    ...
                    if (startVideo.person_ending_position === 'Left') {
                        ...
                        const matchingTransition5 = transitions.find(
                            (transition) => {
                                return (
                                    transition.asana_category_end ===
                                        'Sitting' &&
