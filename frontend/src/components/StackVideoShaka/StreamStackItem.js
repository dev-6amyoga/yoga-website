		...
		async (isDrm) => {
			try {
				...
				if (!offlineUri) {
					if (isDrm) {
						console.log(
							"[StreamStackItem:loadVideo] DRM video processing"
						);

						try {
							console.log(
								"[StreamStackItem:loadVideo] Downloading DRM video"
							);
						...
						console.log(
							"[StreamStackItem:loadVideo] Downloading video"
						);
				...
				if (offlineUri) {
					...
					console.log(
						"[StreamStackItem:loadVideo] Offline video loaded"
					);
					...
					console.log(
						"[StreamStackItem:loadVideo] Online video loaded"
					);
					setMetadataLoaded(true);
				}
			} catch (error) {
...
//           if (!offlineUri) {
//             console.log("[StreamStackItem:loadVideo] Checking temp storage");
//             const tempFilePath = await getVideoFromTempOrDownload(
//               videoUrl,
//               videoTitle
//             );
...
//             if (tempFilePath) {
//               console.log(
//                 `[StreamStackItem:loadVideo] Storing DRM video from temp: ${tempFilePath}`
//               );
//               const offlineVideo = await shakaOfflineStore.store(
//                 videoUrl,
//                 videoTitle,
...
//           if (tempFilePath) {
//             console.log(
//               `[StreamStackItem:loadVideo] Storing non-DRM video from temp: ${tempFilePath}`
//             );
//             const offlineVideo = await shakaOfflineStore.store(
//               videoUrl,
//               videoTitle
...
//       if (offlineUri) {
//         console.log(
//           "[StreamStackItem:loadVideo] Offline video available, loading:",
//           offlineUri
//         );
//         await playerRef.current.player.load(offlineUri);
...
//       } else {
//         console.error(
//           "[StreamStackItem:loadVideo] No offline video available, trying temp or online"
//         );
...
//         if (tempFilePath) {
//           console.log(
//             `[StreamStackItem:loadVideo] Playing directly from temp: ${tempFilePath}`
//           );
//           await playerRef.current.player.load(tempFilePath);
//           setMetadataLoaded(true);
//         } else {
//           console.log(
//             "[StreamStackItem:loadVideo] Playing online video:",
//             videoUrl
//           );
//           await playerRef.current.player.load(videoUrl);
//           setMetadataLoaded(true);
...
//       }
//     } catch (error) {
//       console.error("[StreamStackItem:loadVideo] Error loading video:", error);
//       playerOnError(error);
//     }
//   },
