  ...
  return (
    ...
    >
                ...
                <div className="relative h-full w-full">
                  {queue.length > 0 ? (
                    <StreamStackItem
                      ...
                      updatedAt={queueItem?.video?.last_updated || 0}
                      video={queueItem}
                      handleEnd={handleEnd}
                      handleLoading={handleLoading}
                      handlePlaybackError={handlePlaybackError}
                      isActive={currentVideo?.queue_id === queueItem?.queue_id}
      ...
      >
        ...
        <DialogContent>
          <p>Would you like to record yourself during this yoga session?</p>
        </DialogContent>
        <DialogActions>
