...
import { Loading, Toggle, Tooltip } from "@geist-ui/core";
...
import { FastForward } from "@geist-ui/icons";
    ...
    <div className="flex items-center justify-between px-4 pb-1">
      <div className="flex items-center justify-start rounded-xl text-white">
        ...
        <button
          ...
          className={iconButtonClass + " hidden md:block"}
        >
          <FaStepForward style={{ fontSize: "24px", color: "red" }} />
        </button>
        ...
        {currentMarkerIdx !== null && markers.length > 0 ? (
          ...
          >
            {String(markers[currentMarkerIdx].title).substring(0, 80) + "..." ??
              ""}
          </span>
        ) : (
          <></>
