...
export default function PlaylistSectionsStudent() {
        ...
        <div className="flex flex-col gap-2 py-2">
          ...
          <div className="flex flex-row gap-1 justify-between border-t py-2">
            <div className="flex flex-row gap-2 items-center">
              <div
                className={`w-2 h-2 rounded-full ${inSync ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              <p className="text-sm">{inSync ? "In sync" : "Out of sync"}</p>
            </div>
            <Button
              size="small"
              variant="outlined"
