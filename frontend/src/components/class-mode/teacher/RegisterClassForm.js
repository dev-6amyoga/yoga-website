			...
			<Modal.Content>
				<form
					...
					<p className="text-sm pt-4">
						One time Classes start and end at a particular time on
						the selected date.
						<br />
						Recurring Classes can repeat regularly at some
						frequency.
					</p>
					<FormControl fullWidth>
						...
						<Select
							...
							<MenuItem value="CLASS_TYPE_ONETIME">
								One time class
							</MenuItem>
							<MenuItem value="CLASS_TYPE_RECURRING">
								Recurring Class
							</MenuItem>
						</Select>
					</FormControl>
					...
					{classType === CLASS_TYPE_RECURRING &&
						recurranceType === CLASS_RECURRANCE_TYPE_DAILY && (
							<p className="text-sm mt-2">
								Classes will be scheduled every day at the same
								time
							</p>
						)}
					...
					{classType === CLASS_TYPE_RECURRING &&
						recurranceType === CLASS_RECURRANCE_TYPE_WEEKLY && (
							<p className="text-sm mt-2">
								Classes will be scheduled every week on the
								selected days at the same time
							</p>
						)}
					...
					{classType === CLASS_TYPE_RECURRING &&
						recurranceType ===
							...
							<p className="text-sm mt-2">
								Classes will be scheduled every fortnight (15
					...
					{classType === CLASS_TYPE_RECURRING &&
						recurranceType === CLASS_RECURRANCE_TYPE_MONTHLY && (
							<p className="text-sm mt-2">
								Classes will be scheduled every month at the
								same time on selected dates
							</p>
						)}
