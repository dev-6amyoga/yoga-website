...
import { Button, Select, Text, Input } from "@geist-ui/core";
import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import getFormData from "../../../utils/getFormData";
import { toast } from "react-toastify";
export default function RegisterTransitionVideoForm() {
    ...
    if (
      ...
      for (var i = 0; i !== data.length; i++) {
        if (
          ...
          data[i].transition_video_ID === combinedData.transition_video_ID
        ) {
  ...
  return (
    <AdminPageWrapper heading="Register Transition Video">
      <div className="flex items-center justify-center min-h-screen max-w-5xl mx-auto">
        <form
        ...
        >
          ...
          <Input width="100%" name="transition_video_ID">
            {/* Cloudflare ID */}
          </Input>
          <Text>Language</Text>
          <Select
